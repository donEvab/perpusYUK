<%-- 
    Document   : peminjaman_anggota
    Created on : May 14, 2026, 7:16:34 PM
    Author     : zamza
--%>
...
<%
    ...
    if ("pinjam".equals(aksi)) {
        ...
        pm.prosesPinjam(userId, idBuku, tanggalKembali);
        msg = "Permintaan peminjaman berhasil!";
    }
...
<div class="sidebar">
    ...
    <a href="peminjaman_anggota.jsp" class="active">🔄 Peminjaman & Pengembalian</a>
    <a href="notifikasi_anggota.jsp">🔔 Notifikasi</a>
...
<div class="modal-overlay" id="modalPinjam">
    <div class="modal">
        <h3>Pinjam Buku</h3>
        <form method="post" action="peminjaman_anggota.jsp">
